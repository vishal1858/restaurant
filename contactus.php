...
<html>
  ...
  <head>
    <title> Contact | Skylight Cafe' </title>
  </head>
...
?>
    ...
    <div class="heading">
     <strong>Want to contact <span class="edit"> Skylight Cafe' </span>?</strong>
     <br>
      ...
      <div class="form-area">
        ...
        <br style="clear: both">
          ...
          <div class="form-group">
            <input type="text" class="form-control" id="name" name="fullname" placeholder="Name" required autofocus="">
          </div>
...
$Mobile_No = $conn->real_escape_string($_POST['contact']);
$Subject = $conn->real_escape_string($_POST['subject']);
$Message = $conn->real_escape_string($_POST['message']);

$query = "INSERT into contact(fullname,email,contact,Subject,Message) VALUES('$Name','$Email_Id','$Mobile_No','$Subject','$Message')";
